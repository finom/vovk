// auto-generated by vovk-cli v0.0.1-draft.333 at 2025-08-24T16:29:38.837Z
...
export const ValibotControllerOnlyEntityRPC = createRPC<Controllers0['ValibotControllerOnlyEntityRPC'], Options>(
  schema,
  'generated',
...
export const ValibotControllerAndServiceEntityRPC = createRPC<
  Controllers0['ValibotControllerAndServiceEntityRPC'],
  Options
>(schema, 'generated', 'ValibotControllerAndServiceEntityRPC', fetcher, {
  validateOnClient,
  apiRoot: 'http://localhost:3210/api',
});

export const ArktypeControllerOnlyEntityRPC = createRPC<Controllers0['ArktypeControllerOnlyEntityRPC'], Options>(
  schema,
  'generated',
...
export const ArktypeControllerAndServiceEntityRPC = createRPC<
  Controllers0['ArktypeControllerAndServiceEntityRPC'],
  Options
>(schema, 'generated', 'ArktypeControllerAndServiceEntityRPC', fetcher, {
  validateOnClient,
  apiRoot: 'http://localhost:3210/api',
});
