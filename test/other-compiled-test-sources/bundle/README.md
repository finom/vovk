<!-- auto-generated by vovk-cli v0.0.1-draft.331 at 2025-08-17T17:09:58.502Z -->
...
`POST http://localhost:3000/api/foo/client/with-zod/handle-body-zod3`
...
`POST http://localhost:3000/api/foo/client/with-zod/handle-form-data-with-multiple-files`
...
`GET http://localhost:3000/api/foo/client/with-zod/handle-pagination`
...
`POST http://localhost:3000/api/foo/client/with-dto/handle-form-data-client`
