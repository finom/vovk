...
var require_types$2 = __commonJS({ "../packages/vovk/dist/types.js"(exports) {
...
var require_HttpException = __commonJS({ "../packages/vovk/dist/HttpException.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_shim = __commonJS({ "../packages/vovk/dist/utils/shim.js"() {
...
var require_JSONLinesResponse = __commonJS({ "../packages/vovk/dist/JSONLinesResponse.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_parseQuery = __commonJS({ "../packages/vovk/dist/utils/parseQuery.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_reqQuery = __commonJS({ "../packages/vovk/dist/utils/reqQuery.js"(exports) {
...
var require_reqMeta = __commonJS({ "../packages/vovk/dist/utils/reqMeta.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_reqForm = __commonJS({ "../packages/vovk/dist/utils/reqForm.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_VovkApp = __commonJS({ "../packages/vovk/dist/VovkApp.js"(exports) {
	...
	var VovkApp = class {
			...
			if (!methodKeys.length) methodKeys = allMethodKeys.filter((p) => {
				...
				for (let i = 0; i < routeSegments.length; i++) {
					...
					if (routeSegment.startsWith(":")) {
						...
						if (parameter in methodParams) throw new HttpException_1$5.HttpException(types_1$7.HttpStatus.INTERNAL_SERVER_ERROR, `Duplicate parameter "${parameter}" at ${p}`);
						methodParams[parameter] = pathSegment;
					} else if (routeSegment !== pathSegment) return false;
				}
				return true;
			});
			if (methodKeys.length > 1) throw new HttpException_1$5.HttpException(types_1$7.HttpStatus.INTERNAL_SERVER_ERROR, `Conflicting routes found: ${methodKeys.join(", ")}`);
		...
		#callMethod = async (httpMethod, nextReq, params) => {
			...
			controllers$2.forEach((staticMethods, controller$1) => {
				...
				if (!controller$1._activated) throw new HttpException_1$5.HttpException(types_1$7.HttpStatus.INTERNAL_SERVER_ERROR, `Controller "${controller$1.name}" found but not activated`);
			...
			if (!handler) return this.#respondWithError(types_1$7.HttpStatus.NOT_FOUND, `${Object.keys(handlers)} - Route ${path.join("/")} is not found`);
			...
			try {
				...
				const isIterator = typeof result === "object" && !!result && (Reflect.has(result, Symbol.iterator) && typeof result[Symbol.iterator] === "function" || Reflect.has(result, Symbol.asyncIterator) && typeof result[Symbol.asyncIterator] === "function");
				if (isIterator && !(result instanceof Array)) {
					const streamResponse = new JSONLinesResponse_1$1.JSONLinesResponse(await (0, headers_1.headers)(), { headers: { ..._a$1.getHeadersFromOptions(staticMethod._options) } });
					(async () => {
						try {
...
var require_getSchema = __commonJS({ "../packages/vovk/dist/utils/getSchema.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function getControllerSchema(controller, rpcModuleName, exposeValidation) {
		return {
			...
			handlers: { ...exposeValidation ? controller._handlers : Object.fromEntries(
	...
	function getSchema(options) {
		...
		for (const [rpcModuleName, controller] of Object.entries(options.controllers)) schema.controllers[rpcModuleName] = getControllerSchema(controller, rpcModuleName, exposeValidation);
		return schema;
	}
} });
...
var require_createVovkApp = __commonJS({ "../packages/vovk/dist/createVovkApp.js"(exports) {
	...
	const assignSchema = ({ controller, propertyKey, path, options, httpMethod, vovkApp }) => {
		if (typeof window !== "undefined") throw new Error("Decorators are intended for server-side use only. You have probably imported a controller on the client-side.");
...
var require_fetcher = __commonJS({ "../packages/vovk/dist/client/fetcher.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function createFetcher({ prepareRequestInit, transformResponse } = {}) {
		const newFetcher = async ({ httpMethod, getEndpoint, validate: validate$1, defaultHandler: defaultHandler$1, defaultStreamHandler: defaultStreamHandler$1 }, options) => {
			...
			if (unusedParams.length) throw new HttpException_1$4.HttpException(types_1$5.HttpStatus.NULL, `Unused params: ${unusedParams.join(", ")} in ${endpoint}`, {
				body,
				query,
				params,
				endpoint
			...
			if (!disableClientValidation) try {
				...
				throw new HttpException_1$4.HttpException(types_1$5.HttpStatus.NULL, e.message ?? exports.DEFAULT_ERROR_MESSAGE, {
					body,
					query,
					params,
					endpoint
...
var require_defaultHandler = __commonJS({ "../packages/vovk/dist/client/defaultHandler.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const defaultHandler = async (response) => {
		...
		if (!response.ok) {
			...
			throw new HttpException_1$3.HttpException(response.status, errorResponse?.message ?? exports.DEFAULT_ERROR_MESSAGE, errorResponse?.cause);
		}
		return result;
	};
...
var require_defaultStreamHandler = __commonJS({ "../packages/vovk/dist/client/defaultStreamHandler.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const defaultStreamHandler = async (response) => {
		...
		if (!response.body) throw new HttpException_1$2.HttpException(types_1$4.HttpStatus.NULL, "Stream body is falsy. Check your controller code.");
...
var require_serializeQuery = __commonJS({ "../packages/vovk/dist/utils/serializeQuery.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_createRPC = __commonJS({ "../packages/vovk/dist/client/createRPC.js"(exports) {
	...
	const createRPC$1 = (fullSchema$1, segmentName$2, rpcModuleName, options) => {
		...
		for (const [staticMethodName, handlerSchema] of Object.entries(controllerSchema.handlers)) {
			...
			const getEndpoint = ({ apiRoot, params, query }) => {
				const mainPrefix = (apiRoot.startsWith("http://") || apiRoot.startsWith("https://") || apiRoot.startsWith("/") ? "" : "/") + (apiRoot.endsWith("/") ? apiRoot : `${apiRoot}/`) + (segmentName$2 ? `${segmentName$2}/` : "");
...
var require_client = __commonJS({ "../packages/vovk/dist/client/index.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_createDecorator = __commonJS({ "../packages/vovk/dist/createDecorator.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_generateStaticAPI = __commonJS({ "../packages/vovk/dist/utils/generateStaticAPI.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_setHandlerSchema = __commonJS({ "../packages/vovk/dist/utils/setHandlerSchema.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_withValidation = __commonJS({ "../packages/vovk/dist/utils/withValidation.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function withValidation({ disableServerSideValidation, skipSchemaEmission, validateEachIteration, body, query, params, output, iteration, handle, getJSONSchemaFromModel, validate: validate$1 }) {
		...
		const outputHandler = async (req, handlerParams) => {
			...
			if (output && iteration) throw new HttpException_1$1.HttpException(types_1$3.HttpStatus.INTERNAL_SERVER_ERROR, "Output and iteration are mutually exclusive. You can't use them together.");
			if (output && !disableServerSideValidationKeys.includes("output")) {
				if (!data) throw new HttpException_1$1.HttpException(types_1$3.HttpStatus.INTERNAL_SERVER_ERROR, "Output is required. You probably forgot to return something from your handler.");
			...
			if (iteration && !disableServerSideValidationKeys.includes("iteration")) {
				if (!data || typeof data[Symbol.asyncIterator] !== "function") throw new HttpException_1$1.HttpException(types_1$3.HttpStatus.INTERNAL_SERVER_ERROR, "Data is not an async iterable but iteration validation is defined.");
				return async function* () {
					let i = 0;
					for await (const item of data) {
						if (validateEachIteration || i === 0) await validate$1(item, iteration, {
							type: "iteration",
							req,
							status: 200,
							i
			...
			} else if (validateEachIteration) throw new HttpException_1$1.HttpException(types_1$3.HttpStatus.INTERNAL_SERVER_ERROR, "validateEachIteration is set but iteration is not defined.");
			return data;
		};
		...
		if (getJSONSchemaFromModel) {
			const validation$2 = {};
			if (body && !skipSchemaEmissionKeys.includes("body")) validation$2.body = getJSONSchemaFromModel(body, { type: "body" });
			if (query && !skipSchemaEmissionKeys.includes("query")) validation$2.query = getJSONSchemaFromModel(query, { type: "query" });
			if (params && !skipSchemaEmissionKeys.includes("params")) validation$2.params = getJSONSchemaFromModel(params, { type: "params" });
			if (output && !skipSchemaEmissionKeys.includes("output")) validation$2.output = getJSONSchemaFromModel(output, { type: "output" });
			if (iteration && !skipSchemaEmissionKeys.includes("iteration")) validation$2.iteration = getJSONSchemaFromModel(iteration, { type: "iteration" });
...
var require_dist$2 = __commonJS({ "../packages/vovk/dist/index.js"(exports) {
	var _a;
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_code$3 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/codegen/code.js"(exports) {
	...
	var _Code$1 = class extends _CodeOrName$1 {
		...
		get names() {
			var _a$2;
			return (_a$2 = this._names) !== null && _a$2 !== void 0 ? _a$2 : this._names = this._items.reduce((names$2, c) => {
...
var require_util$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/util.js"(exports) {
	...
	function makeMergeEvaluated$1({ mergeNames, mergeToName, mergeValues, resultToName }) {
		return (gen, from, to, toName) => {
			const res = to === void 0 ? from : to instanceof codegen_1$74.Name ? (from instanceof codegen_1$74.Name ? mergeNames(gen, from, to) : mergeToName(gen, from, to), to) : from instanceof codegen_1$74.Name ? (mergeToName(gen, to, from), from) : mergeValues(from, to);
			return toName === codegen_1$74.Name && !(res instanceof codegen_1$74.Name) ? resultToName(gen, res) : res;
		};
	}
	exports.mergeEvaluated = {
		props: makeMergeEvaluated$1({
			mergeNames: (gen, from, to) => gen.if((0, codegen_1$74._)`${to} !== true && ${from} !== undefined`, () => {
				gen.if((0, codegen_1$74._)`${from} === true`, () => gen.assign(to, true), () => gen.assign(to, (0, codegen_1$74._)`${to} || {}`).code((0, codegen_1$74._)`Object.assign(${to}, ${from})`));
			}),
			mergeToName: (gen, from, to) => gen.if((0, codegen_1$74._)`${to} !== true`, () => {
		...
		items: makeMergeEvaluated$1({
			mergeNames: (gen, from, to) => gen.if((0, codegen_1$74._)`${to} !== true && ${from} !== undefined`, () => gen.assign(to, (0, codegen_1$74._)`${from} === true ? true : ${to} > ${from} ? ${to} : ${from}`)),
			mergeToName: (gen, from, to) => gen.if((0, codegen_1$74._)`${to} !== true`, () => gen.assign(to, from === true ? true : (0, codegen_1$74._)`${to} > ${from} ? ${to} : ${from}`)),
	...
	function setEvaluated$1(gen, props, ps) {
		Object.keys(ps).forEach((p) => gen.assign((0, codegen_1$74._)`${props}${(0, codegen_1$74.getProperty)(p)}`, true));
	}
	...
	function getErrorPath$1(dataProp, dataPropType, jsPropertySyntax) {
		if (dataProp instanceof codegen_1$74.Name) {
			...
			return jsPropertySyntax ? isNumber ? (0, codegen_1$74._)`"[" + ${dataProp} + "]"` : (0, codegen_1$74._)`"['" + ${dataProp} + "']"` : isNumber ? (0, codegen_1$74._)`"/" + ${dataProp}` : (0, codegen_1$74._)`"/" + ${dataProp}.replace(/~/g, "~0").replace(/\\//g, "~1")`;
		}
		return jsPropertySyntax ? (0, codegen_1$74.getProperty)(dataProp).toString() : "/" + escapeJsonPointer$1(dataProp);
	}
...
var require_errors$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/errors.js"(exports) {
	...
	exports.keywordError = { message: ({ keyword: keyword$1 }) => (0, codegen_1$72.str)`must pass "${keyword$1}" keyword validation` };
	exports.keyword$DataError = { message: ({ keyword: keyword$1, schemaType }) => schemaType ? (0, codegen_1$72.str)`"${keyword$1}" keyword must be ${schemaType} ($data)` : (0, codegen_1$72.str)`"${keyword$1}" keyword is invalid ($data)` };
	...
	function resetErrorsCount$1(gen, errsCount) {
		...
		gen.if((0, codegen_1$72._)`${names_1$16.default.vErrors} !== null`, () => gen.if(errsCount, () => gen.assign((0, codegen_1$72._)`${names_1$16.default.vErrors}.length`, errsCount), () => gen.assign(names_1$16.default.vErrors, null)));
	}
	...
	function extendErrors$1({ gen, keyword: keyword$1, schemaValue, data, errsCount, it }) {
		...
		gen.forRange("i", errsCount, names_1$16.default.errors, (i) => {
			...
			gen.if((0, codegen_1$72._)`${err}.instancePath === undefined`, () => gen.assign((0, codegen_1$72._)`${err}.instancePath`, (0, codegen_1$72.strConcat)(names_1$16.default.instancePath, it.errorPath)));
	...
	function addError$1(gen, errObj) {
		...
		gen.if((0, codegen_1$72._)`${names_1$16.default.vErrors} === null`, () => gen.assign(names_1$16.default.vErrors, (0, codegen_1$72._)`[${err}]`), (0, codegen_1$72._)`${names_1$16.default.vErrors}.push(${err})`);
	...
	function errorInstancePath$1({ errorPath }, { instancePath }) {
		const instPath = instancePath ? (0, codegen_1$72.str)`${errorPath}${(0, util_1$59.getErrorPath)(instancePath, util_1$59.Type.Str)}` : errorPath;
	...
	function errorSchemaPath$1({ keyword: keyword$1, it: { errSchemaPath } }, { schemaPath, parentSchema }) {
		...
		if (schemaPath) schPath = (0, codegen_1$72.str)`${schPath}${(0, util_1$59.getErrorPath)(schemaPath, util_1$59.Type.Str)}`;
	...
	function extraErrorProps$1(cxt, { params, message }, keyValues) {
		...
		keyValues.push([E$1.keyword, keyword$1], [E$1.params, typeof params == "function" ? params(cxt) : params || (0, codegen_1$72._)`{}`]);
		if (opts.messages) keyValues.push([E$1.message, typeof message == "function" ? message(cxt) : message]);
		if (opts.verbose) keyValues.push([E$1.schema, schemaValue], [E$1.parentSchema, (0, codegen_1$72._)`${topSchemaRef}${schemaPath}`], [names_1$16.default.data, data]);
...
var require_dataType$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/validate/dataType.js"(exports) {
	...
	function coerceData$1(it, types, coerceTo) {
		...
		if (opts.coerceTypes === "array") gen.if((0, codegen_1$70._)`${dataType} == 'object' && Array.isArray(${data}) && ${data}.length == 1`, () => gen.assign(data, (0, codegen_1$70._)`${data}[0]`).assign(dataType, (0, codegen_1$70._)`typeof ${data}`).if(checkDataTypes$1(types, data, opts.strictNumbers), () => gen.assign(coerced, data)));
		...
		function coerceSpecificType(t) {
			switch (t) {
				case "string":
					gen.elseIf((0, codegen_1$70._)`${dataType} == "number" || ${dataType} == "boolean"`).assign(coerced, (0, codegen_1$70._)`"" + ${data}`).elseIf((0, codegen_1$70._)`${data} === null`).assign(coerced, (0, codegen_1$70._)`""`);
					return;
				case "number":
					gen.elseIf((0, codegen_1$70._)`${dataType} == "boolean" || ${data} === null
              || (${dataType} == "string" && ${data} && ${data} == +${data})`).assign(coerced, (0, codegen_1$70._)`+${data}`);
					return;
				case "integer":
					gen.elseIf((0, codegen_1$70._)`${dataType} === "boolean" || ${data} === null
              || (${dataType} === "string" && ${data} && ${data} == +${data} && !(${data} % 1))`).assign(coerced, (0, codegen_1$70._)`+${data}`);
					return;
				case "boolean":
					gen.elseIf((0, codegen_1$70._)`${data} === "false" || ${data} === 0 || ${data} === null`).assign(coerced, false).elseIf((0, codegen_1$70._)`${data} === "true" || ${data} === 1`).assign(coerced, true);
					return;
				case "null":
					gen.elseIf((0, codegen_1$70._)`${data} === "" || ${data} === 0 || ${data} === false`);
					gen.assign(coerced, null);
					return;
				case "array": gen.elseIf((0, codegen_1$70._)`${dataType} === "string" || ${dataType} === "number"
              || ${dataType} === "boolean" || ${data} === null`).assign(coerced, (0, codegen_1$70._)`[${data}]`);
			}
		}
	}
	function assignParentData$1({ gen, parentData, parentDataProperty }, expr) {
		gen.if((0, codegen_1$70._)`${parentData} !== undefined`, () => gen.assign((0, codegen_1$70._)`${parentData}[${parentDataProperty}]`, expr));
	}
	function checkDataType$1(dataType, data, strictNums, correct = DataType$1.Correct) {
		...
		let cond;
		switch (dataType) {
			case "null": return (0, codegen_1$70._)`${data} ${EQ} null`;
			case "array":
			...
			case "number":
				cond = numCond();
				break;
			default: return (0, codegen_1$70._)`typeof ${data} ${EQ} ${dataType}`;
		}
		return correct === DataType$1.Correct ? cond : (0, codegen_1$70.not)(cond);
		function numCond(_cond = codegen_1$70.nil) {
			return (0, codegen_1$70.and)((0, codegen_1$70._)`typeof ${data} == "number"`, _cond, strictNums ? (0, codegen_1$70._)`isFinite(${data})` : codegen_1$70.nil);
		}
	}
	...
	const typeError$1 = {
		...
		params: ({ schema, schemaValue }) => typeof schema == "string" ? (0, codegen_1$70._)`{type: ${schema}}` : (0, codegen_1$70._)`{type: ${schemaValue}}`
	};
...
var require_defaults$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/validate/defaults.js"(exports) {
	...
	function assignDefault$1(it, prop, defaultValue) {
		...
		if (opts.useDefaults === "empty") condition = (0, codegen_1$69._)`${condition} || ${childData} === null || ${childData} === ""`;
...
var require_code$2 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/code.js"(exports) {
	...
	function checkMissingProp$1({ gen, data, it: { opts } }, properties, missing) {
		return (0, codegen_1$68.or)(...properties.map((prop) => (0, codegen_1$68.and)(noPropertyInData$1(gen, data, prop, opts.ownProperties), (0, codegen_1$68._)`${missing} = ${prop}`)));
	}
	...
	function noPropertyInData$1(gen, data, property, ownProperties) {
		const cond = (0, codegen_1$68._)`${data}${(0, codegen_1$68.getProperty)(property)} === undefined`;
		return ownProperties ? (0, codegen_1$68.or)(cond, (0, codegen_1$68.not)(isOwnProperty$1(gen, data, property))) : cond;
	}
	...
	function callValidateCode$1({ schemaCode, data, it: { gen, topSchemaRef, schemaPath, errorPath }, it }, func, context, passSchema) {
		const dataAndSchema = passSchema ? (0, codegen_1$68._)`${schemaCode}, ${data}, ${topSchemaRef}${schemaPath}` : data;
		const valCxt = [
		...
		return context !== codegen_1$68.nil ? (0, codegen_1$68._)`${func}.call(${context}, ${args})` : (0, codegen_1$68._)`${func}(${args})`;
	}
	...
	function usePattern$1({ gen, it: { opts } }, pattern) {
		...
		return gen.scopeValue("pattern", {
			key: rx.toString(),
			ref: rx,
			code: (0, codegen_1$68._)`${regExp.code === "new RegExp" ? newRegExp$1 : (0, util_2$3.useFunc)(gen, regExp)}(${pattern}, ${u})`
		});
	}
...
var require_keyword$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/validate/keyword.js"(exports) {
	...
	function funcKeywordCode$1(cxt, def$60) {
		...
		const validate$1 = !$data && def$60.compile ? def$60.compile.call(it.self, schema, parentSchema, it) : def$60.validate;
		...
		function validateAsync() {
			...
			gen.try(() => assignValid((0, codegen_1$67._)`await `), (e) => gen.assign(valid, false).if((0, codegen_1$67._)`${e} instanceof ${it.ValidationError}`, () => gen.assign(ruleErrs, (0, codegen_1$67._)`${e}.errors`), () => gen.throw(e)));
			return ruleErrs;
		}
		...
		function assignValid(_await = def$60.async ? (0, codegen_1$67._)`await ` : codegen_1$67.nil) {
			...
			gen.assign(valid, (0, codegen_1$67._)`${_await}${(0, code_1$25.callValidateCode)(cxt, validateRef, passCxt, passSchema)}`, def$60.modifying);
		}
	...
	function addErrs$1(cxt, errs) {
		const { gen } = cxt;
		gen.if((0, codegen_1$67._)`Array.isArray(${errs})`, () => {
			gen.assign(names_1$13.default.vErrors, (0, codegen_1$67._)`${names_1$13.default.vErrors} === null ? ${errs} : ${names_1$13.default.vErrors}.concat(${errs})`).assign(names_1$13.default.errors, (0, codegen_1$67._)`${names_1$13.default.vErrors}.length`);
	...
	function validateKeywordUsage$1({ schema, opts, self, errSchemaPath }, def$60, keyword$1) {
		/* istanbul ignore if */
		if (Array.isArray(def$60.keyword) ? !def$60.keyword.includes(keyword$1) : def$60.keyword !== keyword$1) throw new Error("ajv implementation error");
		const deps = def$60.dependencies;
		if (deps === null || deps === void 0 ? void 0 : deps.some((kwd) => !Object.prototype.hasOwnProperty.call(schema, kwd))) throw new Error(`parent schema must have dependencies of ${keyword$1}: ${deps.join(",")}`);
		if (def$60.validateSchema) {
			const valid = def$60.validateSchema(schema[keyword$1]);
			if (!valid) {
				const msg = `keyword "${keyword$1}" value is invalid at path "${errSchemaPath}": ` + self.errorsText(def$60.validateSchema.errors);
...
var require_subschema$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/validate/subschema.js"(exports) {
	...
	function getSubschema$1(it, { keyword: keyword$1, schemaProp, schema, schemaPath, errSchemaPath, topSchemaRef }) {
		if (keyword$1 !== void 0 && schema !== void 0) throw new Error("both \"keyword\" and \"schema\" passed, only one allowed");
		if (keyword$1 !== void 0) {
			...
			return schemaProp === void 0 ? {
				...
				schemaPath: (0, codegen_1$66._)`${it.schemaPath}${(0, codegen_1$66.getProperty)(keyword$1)}${(0, codegen_1$66.getProperty)(schemaProp)}`,
	...
	function extendSubschemaData$1(subschema, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
		...
		if (dataProp !== void 0) {
			...
			const nextData = gen.let("data", (0, codegen_1$66._)`${it.data}${(0, codegen_1$66.getProperty)(dataProp)}`, true);
			dataContextProps(nextData);
			subschema.errorPath = (0, codegen_1$66.str)`${errorPath}${(0, util_1$55.getErrorPath)(dataProp, dpType, opts.jsPropertySyntax)}`;
		...
		if (schema && typeof schema == "object" && !Array.isArray(schema)) {
			...
			for (var key in schema) {
				...
				if (Array.isArray(sch)) {
					if (key in traverse$3.arrayKeywords) for (var i = 0; i < sch.length; i++) _traverse$1(opts, pre, post, sch[i], jsonPtr + "/" + key + "/" + i, rootSchema, jsonPtr, key, schema, i);
				} else if (key in traverse$3.propsKeywords) {
					if (sch && typeof sch == "object") for (var prop in sch) _traverse$1(opts, pre, post, sch[prop], jsonPtr + "/" + key + "/" + escapeJsonPtr$1(prop), rootSchema, jsonPtr, key, schema, prop);
				} else if (key in traverse$3.keywords || opts.allKeys && !(key in traverse$3.skipKeywords)) _traverse$1(opts, pre, post, sch, jsonPtr + "/" + key, rootSchema, jsonPtr, key, schema);
			}
...
var require_validate$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/validate/index.js"(exports) {
	...
	function validateFunction$1({ gen, validateName, schema, schemaEnv, opts }, body) {
		if (opts.code.es5) gen.func(validateName, (0, codegen_1$65._)`${names_1$12.default.data}, ${names_1$12.default.valCxt}`, schemaEnv.$async, () => {
			gen.code((0, codegen_1$65._)`"use strict"; ${funcSourceUrl$1(schema, opts)}`);
			destructureValCxtES5$1(gen, opts);
			gen.code(body);
		});
		else gen.func(validateName, (0, codegen_1$65._)`${names_1$12.default.data}, ${destructureValCxt$1(opts)}`, schemaEnv.$async, () => gen.code(funcSourceUrl$1(schema, opts)).code(body));
	}
	function destructureValCxt$1(opts) {
		return (0, codegen_1$65._)`{${names_1$12.default.instancePath}="", ${names_1$12.default.parentData}, ${names_1$12.default.parentDataProperty}, ${names_1$12.default.rootData}=${names_1$12.default.data}${opts.dynamicRef ? (0, codegen_1$65._)`, ${names_1$12.default.dynamicAnchors}={}` : codegen_1$65.nil}}={}`;
	}
	function destructureValCxtES5$1(gen, opts) {
		gen.if(names_1$12.default.valCxt, () => {
			gen.var(names_1$12.default.instancePath, (0, codegen_1$65._)`${names_1$12.default.valCxt}.${names_1$12.default.instancePath}`);
			gen.var(names_1$12.default.parentData, (0, codegen_1$65._)`${names_1$12.default.valCxt}.${names_1$12.default.parentData}`);
			gen.var(names_1$12.default.parentDataProperty, (0, codegen_1$65._)`${names_1$12.default.valCxt}.${names_1$12.default.parentDataProperty}`);
			gen.var(names_1$12.default.rootData, (0, codegen_1$65._)`${names_1$12.default.valCxt}.${names_1$12.default.rootData}`);
			if (opts.dynamicRef) gen.var(names_1$12.default.dynamicAnchors, (0, codegen_1$65._)`${names_1$12.default.valCxt}.${names_1$12.default.dynamicAnchors}`);
		}, () => {
	...
	function resetEvaluated$1(it) {
		...
		gen.if((0, codegen_1$65._)`${it.evaluated}.dynamicProps`, () => gen.assign((0, codegen_1$65._)`${it.evaluated}.props`, (0, codegen_1$65._)`undefined`));
		gen.if((0, codegen_1$65._)`${it.evaluated}.dynamicItems`, () => gen.assign((0, codegen_1$65._)`${it.evaluated}.items`, (0, codegen_1$65._)`undefined`));
	}
	function funcSourceUrl$1(schema, opts) {
		const schId = typeof schema == "object" && schema[opts.schemaId];
		return schId && (opts.code.source || opts.code.process) ? (0, codegen_1$65._)`/*# sourceURL=${schId} */` : codegen_1$65.nil;
	}
	...
	function checkRefsAndKeywords$1(it) {
		...
		if (schema.$ref && opts.ignoreKeywordsWithRef && (0, util_1$53.schemaHasRulesButRef)(schema, self.RULES)) self.logger.warn(`$ref: keywords ignored in schema at path "${errSchemaPath}"`);
	}
	function checkNoDefault$1(it) {
		const { schema, opts } = it;
		if (schema.default !== void 0 && opts.useDefaults && opts.strictSchema) (0, util_1$53.checkStrictMode)(it, "default is ignored in the schema root");
	}
	...
	function commentKeyword$1({ gen, schemaEnv, schema, errSchemaPath, opts }) {
		...
		if (opts.$comment === true) gen.code((0, codegen_1$65._)`${names_1$12.default.self}.logger.log(${msg})`);
			...
			gen.code((0, codegen_1$65._)`${names_1$12.default.self}.opts.$comment(${msg}, ${schemaPath}, ${rootName}.schema)`);
		}
	}
	function returnResults$1(it) {
		const { gen, schemaEnv, validateName, ValidationError: ValidationError$2, opts } = it;
		if (schemaEnv.$async) gen.if((0, codegen_1$65._)`${names_1$12.default.errors} === 0`, () => gen.return(names_1$12.default.data), () => gen.throw((0, codegen_1$65._)`new ${ValidationError$2}(${names_1$12.default.vErrors})`));
		else {
	...
	function iterateKeywords$1(it, group) {
		...
		gen.block(() => {
			for (const rule of group.rules) if ((0, applicability_1$2.shouldUseRule)(schema, rule)) keywordCode$1(it, rule.keyword, rule.definition, group.type);
		});
	}
	...
	var KeywordCxt$1 = class {
		constructor(it, def$60, keyword$1) {
			...
			if (this.$data) this.schemaCode = it.gen.const("vSchema", getData$1(this.$data, it));
				...
				if (!(0, keyword_1$1.validSchemaType)(this.schema, def$60.schemaType, def$60.allowUndefined)) throw new Error(`${keyword$1} value must be ${JSON.stringify(def$60.schemaType)}`);
			}
			if ("code" in def$60 ? def$60.trackErrors : def$60.errors !== false) this.errsCount = it.gen.const("_errs", names_1$12.default.errors);
		}
		...
		fail$data(condition) {
			...
			this.fail((0, codegen_1$65._)`${schemaCode} !== undefined && (${(0, codegen_1$65.or)(this.invalid$data(), condition)})`);
		}
		...
		invalid$data() {
			...
			function wrong$DataType() {
				if (schemaType.length) {
					...
					return (0, codegen_1$65._)`${(0, dataType_2$1.checkDataTypes)(st, schemaCode, it.opts.strictNumbers, dataType_2$1.DataType.Wrong)}`;
				}
		...
		mergeEvaluated(schemaCxt, toName) {
			...
			if (it.props !== true && schemaCxt.props !== void 0) it.props = util_1$53.mergeEvaluated.props(gen, schemaCxt.props, it.props, toName);
			if (it.items !== true && schemaCxt.items !== void 0) it.items = util_1$53.mergeEvaluated.items(gen, schemaCxt.items, it.items, toName);
		}
	...
	function getData$1($data, { dataLevel, dataNames, dataPathArr }) {
		...
		for (const segment of segments$1) if (segment) {
			data = (0, codegen_1$65._)`${data}${(0, codegen_1$65.getProperty)((0, util_1$53.unescapeJsonPointer)(segment))}`;
...
var require_compile$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/compile/index.js"(exports) {
	...
	var SchemaEnv$1 = class {
		constructor(env) {
			...
			this.baseId = (_a$2 = env.baseId) !== null && _a$2 !== void 0 ? _a$2 : (0, resolve_1$5.normalizeId)(schema === null || schema === void 0 ? void 0 : schema[env.schemaId || "$id"]);
	...
	function resolveRef$1(root, baseId, ref) {
		...
		if (_sch === void 0) {
			...
			if (schema) _sch = new SchemaEnv$1({
				schema,
				schemaId,
				root,
				baseId
...
var require_core$3 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/core.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Ajv$3 = class {
		...
		addKeyword(kwdOrDef, def$60) {
			...
			(0, util_1$51.eachItem)(keyword$1, definition.type.length === 0 ? (k) => addRule$1.call(this, k, definition) : (k) => definition.type.forEach((t) => addRule$1.call(this, k, definition, t)));
			return this;
		}
	...
	function checkKeyword$1(keyword$1, def$60) {
		...
		if (!def$60) return;
		if (def$60.$data && !("code" in def$60 || "validate" in def$60)) throw new Error("$data keyword must have \"code\" or \"validate\" function");
	}
...
var require_ref$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/core/ref.js"(exports) {
	...
	function getValidate$1(cxt, sch) {
		const { gen } = cxt;
		return sch.validate ? gen.scopeValue("validate", { ref: sch.validate }) : (0, codegen_1$62._)`${gen.scopeValue("wrapper", { ref: sch })}.validate`;
	}
	...
	function callRef$1(cxt, v, sch, $async) {
		...
		function addErrorsFrom(source) {
			...
			gen.assign(names_1$10.default.vErrors, (0, codegen_1$62._)`${names_1$10.default.vErrors} === null ? ${errs} : ${names_1$10.default.vErrors}.concat(${errs})`);
		...
		function addEvaluatedFrom(source) {
			...
			if (it.props !== true) if (schEvaluated && !schEvaluated.dynamicProps) {
				if (schEvaluated.props !== void 0) it.props = util_1$50.mergeEvaluated.props(gen, schEvaluated.props, it.props);
			} else {
			...
			if (it.items !== true) if (schEvaluated && !schEvaluated.dynamicItems) {
				if (schEvaluated.items !== void 0) it.items = util_1$50.mergeEvaluated.items(gen, schEvaluated.items, it.items);
			} else {
...
var require_core$2 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/core/index.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_limitNumber$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/limitNumber.js"(exports) {
	...
	const error$38 = {
		message: ({ keyword: keyword$1, schemaCode }) => (0, codegen_1$61.str)`must be ${KWDs$2[keyword$1].okStr} ${schemaCode}`,
		params: ({ keyword: keyword$1, schemaCode }) => (0, codegen_1$61._)`{comparison: ${KWDs$2[keyword$1].okStr}, limit: ${schemaCode}}`
	};
	const def$57 = {
...
var require_multipleOf$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/multipleOf.js"(exports) {
	...
	const def$56 = {
		...
		code(cxt) {
			...
			const invalid = prec ? (0, codegen_1$60._)`Math.abs(Math.round(${res}) - ${res}) > 1e-${prec}` : (0, codegen_1$60._)`${res} !== parseInt(${res})`;
...
var require_limitLength$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/limitLength.js"(exports) {
	...
	const def$55 = {
		...
		code(cxt) {
			...
			const len = it.opts.unicode === false ? (0, codegen_1$59._)`${data}.length` : (0, codegen_1$59._)`${(0, util_1$49.useFunc)(cxt.gen, ucs2length_1$1.default)}(${data})`;
...
var require_pattern$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/pattern.js"(exports) {
	...
	const def$54 = {
		...
		code(cxt) {
			...
			const regExp = $data ? (0, codegen_1$58._)`(new RegExp(${schemaCode}, ${u}))` : (0, code_1$23.usePattern)(cxt, schema);
...
var require_required$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/required.js"(exports) {
	...
	const error$33 = {
		message: ({ params: { missingProperty } }) => (0, codegen_1$56.str)`must have required property '${missingProperty}'`,
...
var require_uniqueItems$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/uniqueItems.js"(exports) {
	...
	const error$31 = {
		message: ({ params: { i, j } }) => (0, codegen_1$54.str)`must NOT have duplicate items (items ## ${j} and ${i} are identical)`,
		...
		code(cxt) {
			...
			function loopN(i, j) {
				...
				gen.for((0, codegen_1$54._)`;${i}--;`, () => {
					...
					if (itemTypes.length > 1) gen.if((0, codegen_1$54._)`typeof ${item} == "string"`, (0, codegen_1$54._)`${item} += "_"`);
					gen.if((0, codegen_1$54._)`typeof ${indices}[${item}] == "number"`, () => {
			...
			function loopN2(i, j) {
				...
				gen.label(outer).for((0, codegen_1$54._)`;${i}--;`, () => gen.for((0, codegen_1$54._)`${j} = ${i}; ${j}--;`, () => gen.if((0, codegen_1$54._)`${eql}(${data}[${i}], ${data}[${j}])`, () => {
					cxt.error();
...
var require_const$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/const.js"(exports) {
	...
	const def$49 = {
		...
		code(cxt) {
			...
			if ($data || schema && typeof schema == "object") cxt.fail$data((0, codegen_1$53._)`!${(0, util_1$46.useFunc)(gen, equal_1$4.default)}(${data}, ${schemaCode})`);
...
var require_enum$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/enum.js"(exports) {
	...
	const def$48 = {
		...
		code(cxt) {
			...
			let eql;
			const getEql = () => eql !== null && eql !== void 0 ? eql : eql = (0, util_1$45.useFunc)(gen, equal_1$3.default);
			let valid;
			if (useLoop || $data) {
				valid = gen.let("valid");
			...
			function loopEnum() {
				...
				gen.forOf("v", schemaCode, (v) => gen.if((0, codegen_1$52._)`${getEql()}(${data}, ${v})`, () => gen.assign(valid, true).break()));
			}
			function equalCode(vSchema, i) {
				const sch = schema[i];
				return typeof sch === "object" && sch !== null ? (0, codegen_1$52._)`${getEql()}(${data}, ${vSchema}[${i}])` : (0, codegen_1$52._)`${data} === ${sch}`;
			}
		}
	};
...
var require_validation$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/validation/index.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_items$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/items.js"(exports) {
	...
	function validateTuple$1(cxt, extraItems, schArr = cxt.schema) {
		...
		if (it.opts.unevaluated && schArr.length && it.items !== true) it.items = util_1$43.mergeEvaluated.items(gen, schArr.length, it.items);
		const valid = gen.name("valid");
		const len = gen.const("len", (0, codegen_1$50._)`${data}.length`);
		schArr.forEach((sch, i) => {
			if ((0, util_1$43.alwaysValidSchema)(it, sch)) return;
			gen.if((0, codegen_1$50._)`${len} > ${i}`, () => cxt.subschema({
				keyword: keyword$1,
				schemaProp: i,
				dataProp: i
			}, valid));
...
var require_contains$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/contains.js"(exports) {
	...
	const error$26 = {
		message: ({ params: { min, max } }) => max === void 0 ? (0, codegen_1$48.str)`must contain at least ${min} valid item(s)` : (0, codegen_1$48.str)`must contain at least ${min} and no more than ${max} valid item(s)`,
		params: ({ params: { min, max } }) => max === void 0 ? (0, codegen_1$48._)`{minContains: ${min}}` : (0, codegen_1$48._)`{minContains: ${min}, maxContains: ${max}}`
	};
	const def$43 = {
		keyword: "contains",
		type: "array",
...
var require_dependencies$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/dependencies.js"(exports) {
	...
	exports.error = {
		...
		params: ({ params: { property, depsCount, deps, missingProperty } }) => (0, codegen_1$47._)`{property: ${property},
	...
	const def$40 = {
		...
		code(cxt) {
			...
			function isAdditional(key) {
				...
				} else if (props.length) definedProp = (0, codegen_1$45.or)(...props.map((p) => (0, codegen_1$45._)`${key} === ${p}`));
				else definedProp = codegen_1$45.nil;
				if (patProps.length) definedProp = (0, codegen_1$45.or)(definedProp, ...patProps.map((p) => (0, codegen_1$45._)`${(0, code_1$18.usePattern)(cxt, p)}.test(${key})`));
...
var require_properties$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/properties.js"(exports) {
	...
	const def$39 = {
		...
		code(cxt) {
			const { gen, schema, parentSchema, data, it } = cxt;
			if (it.opts.removeAdditional === "all" && parentSchema.additionalProperties === void 0) additionalProperties_1$3.default.code(new validate_1$6.KeywordCxt(it, additionalProperties_1$3.default, "additionalProperties"));
			const allProps = (0, code_1$17.allSchemaProperties)(schema);
			for (const prop of allProps) it.definedProperties.add(prop);
			if (it.opts.unevaluated && allProps.length && it.props !== true) it.props = util_1$37.mergeEvaluated.props(gen, (0, util_1$37.toHash)(allProps), it.props);
...
var require_patternProperties$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/patternProperties.js"(exports) {
	...
	const def$38 = {
		...
		code(cxt) {
			...
			const valid = gen.name("valid");
			if (it.props !== true && !(it.props instanceof codegen_1$44.Name)) it.props = (0, util_2$2.evaluatedPropsToName)(gen, it.props);
			const { props } = it;
			...
			function checkMatchingProperties(pat) {
				for (const prop in checkProperties) if (new RegExp(pat).test(prop)) (0, util_1$36.checkStrictMode)(it, `property ${prop} matches pattern ${pat} (use allowMatchingProperties)`);
			}
		...
		code(cxt) {
			...
			function validateOneOf() {
				schArr.forEach((sch, i) => {
					...
					if (i > 0) gen.if((0, codegen_1$43._)`${schValid} && ${valid}`).assign(valid, false).assign(passing, (0, codegen_1$43._)`[${passing}, ${i}]`).else();
					gen.if(schValid, () => {
						gen.assign(valid, true);
...
var require_if$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/if.js"(exports) {
	...
	const def$33 = {
		...
		code(cxt) {
			...
			if (parentSchema.then === void 0 && parentSchema.else === void 0) (0, util_1$32.checkStrictMode)(it, "\"if\" without \"then\" and \"else\" is ignored");
...
var require_applicator$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/applicator/index.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const def$31 = {
		...
		code(cxt, ruleType) {
			...
			function validate$DataFormat() {
				...
				gen.if((0, codegen_1$41._)`typeof ${fDef} == "object" && !(${fDef} instanceof RegExp)`, () => gen.assign(fType, (0, codegen_1$41._)`${fDef}.type || "string"`).assign(format$2, (0, codegen_1$41._)`${fDef}.validate`), () => gen.assign(fType, (0, codegen_1$41._)`"string"`).assign(format$2, fDef));
				...
				function invalidFmt() {
					const callFormat = schemaEnv.$async ? (0, codegen_1$41._)`(${fDef}.async ? await ${format$2}(${data}) : ${format$2}(${data}))` : (0, codegen_1$41._)`${format$2}(${data})`;
					const validData = (0, codegen_1$41._)`(typeof ${format$2} == "function" ? ${callFormat} : ${format$2}.test(${data}))`;
					return (0, codegen_1$41._)`${format$2} && ${format$2} !== true && ${fType} === ${ruleType} && !${validData}`;
				}
			}
			function validateFormat() {
				...
				function getFormat(fmtDef$1) {
					const code = fmtDef$1 instanceof RegExp ? (0, codegen_1$41.regexpCode)(fmtDef$1) : opts.code.formats ? (0, codegen_1$41._)`${opts.code.formats}${(0, codegen_1$41.getProperty)(schema)}` : void 0;
				...
				function validCondition() {
					...
					return typeof format$2 == "function" ? (0, codegen_1$41._)`${fmtRef}(${data})` : (0, codegen_1$41._)`${fmtRef}.test(${data})`;
				}
			}
		}
	};
...
var require_types$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/discriminator/types.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_discriminator$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/vocabularies/discriminator/index.js"(exports) {
	...
	const error$20 = {
		...
		params: ({ params: { discrError, tag, tagName } }) => (0, codegen_1$40._)`{error: ${discrError}, tag: ${tagName}, tagValue: ${tag}}`
	};
	const def$30 = {
		...
		code(cxt) {
			...
			gen.if((0, codegen_1$40._)`typeof ${tag} == "string"`, () => validateMapping(), () => cxt.error(false, {
			...
			function getMapping() {
				...
				for (let i = 0; i < oneOf.length; i++) {
					let sch = oneOf[i];
					if ((sch === null || sch === void 0 ? void 0 : sch.$ref) && !(0, util_1$30.schemaHasRulesButRef)(sch, it.self.RULES)) {
						const ref = sch.$ref;
...
var require_ajv$1 = __commonJS({ "../packages/vovk-ajv/node_modules/ajv/dist/ajv.js"(exports, module) {
	...
	var Ajv$2 = class extends core_1$2.default {
		...
		_addDefaultMetaSchema() {
			...
			const metaSchema = this.opts.$data ? this.$dataMetaSchema(draft7MetaSchema$1, META_SUPPORT_DATA$1) : draft7MetaSchema$1;
...
var require_dataType = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/compile/validate/dataType.js"(exports) {
	...
	const typeError = {
		message: ({ schema }) => `must be ${schema}`,
		params: ({ schema, schemaValue }) => typeof schema == "string" ? (0, codegen_1$34._)`{type: ${schema}}` : (0, codegen_1$34._)`{type: ${schemaValue}}`
	};
...
var require_keyword = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/compile/validate/keyword.js"(exports) {
	...
	function funcKeywordCode(cxt, def$60) {
		...
		function assignValid(_await = def$60.async ? (0, codegen_1$31._)`await ` : codegen_1$31.nil) {
			...
			const passSchema = !("compile" in def$60 && !$data || def$60.schema === false);
			gen.assign(valid, (0, codegen_1$31._)`${_await}${(0, code_1$11.callValidateCode)(cxt, validateRef, passCxt, passSchema)}`, def$60.modifying);
		}
		function reportErrs(errors) {
			var _a$3;
...
var require_validate = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/compile/validate/index.js"(exports) {
	...
	function validateFunction({ gen, validateName, schema, schemaEnv, opts }, body) {
		...
		else gen.func(validateName, (0, codegen_1$29._)`${names_1$4.default.data}, ${destructureValCxt(opts)}`, schemaEnv.$async, () => gen.code(funcSourceUrl(schema, opts)).code(body));
	}
	...
	var KeywordCxt = class {
		constructor(it, def$60, keyword$1) {
			...
			if (this.$data) this.schemaCode = it.gen.const("vSchema", getData(this.$data, it));
				...
				this.schemaCode = this.schemaValue;
				if (!(0, keyword_1.validSchemaType)(this.schema, def$60.schemaType, def$60.allowUndefined)) throw new Error(`${keyword$1} value must be ${JSON.stringify(def$60.schemaType)}`);
			}
			if ("code" in def$60 ? def$60.trackErrors : def$60.errors !== false) this.errsCount = it.gen.const("_errs", names_1$4.default.errors);
		}
		result(condition, successAction, failAction) {
...
var require_compile = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/compile/index.js"(exports) {
	...
	var SchemaEnv = class {
		constructor(env) {
			...
			this.schemaId = env.schemaId;
			this.root = env.root || this;
			this.baseId = (_a$2 = env.baseId) !== null && _a$2 !== void 0 ? _a$2 : (0, resolve_1$1.normalizeId)(schema === null || schema === void 0 ? void 0 : schema[env.schemaId || "$id"]);
			this.schemaPath = env.schemaPath;
			this.localRefs = env.localRefs;
			this.meta = env.meta;
			this.$async = schema === null || schema === void 0 ? void 0 : schema.$async;
...
var require_pattern = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/vocabularies/validation/pattern.js"(exports) {
	...
	const def$24 = {
		...
		code(cxt) {
			const { data, $data, schema, schemaCode, it } = cxt;
			const u = it.opts.unicodeRegExp ? "u" : "";
			const regExp = $data ? (0, codegen_1$22._)`(new RegExp(${schemaCode}, ${u}))` : (0, code_1$9.usePattern)(cxt, schema);
...
var require_const = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/vocabularies/validation/const.js"(exports) {
	...
	const def$19 = {
		...
		code(cxt) {
			const { gen, data, $data, schemaCode, schema } = cxt;
			if ($data || schema && typeof schema == "object") cxt.fail$data((0, codegen_1$17._)`!${(0, util_1$16.useFunc)(gen, equal_1$1.default)}(${data}, ${schemaCode})`);
...
var require_types = __commonJS({ "../node_modules/ajv-formats/node_modules/ajv/dist/vocabularies/discriminator/types.js"(exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.DiscrError = void 0;
	var DiscrError;
	(function(DiscrError$2) {
	...
	exports.formatLimitDefinition = {
		...
		code(cxt) {
			...
			function validateFormat() {
				...
				if (typeof fmtDef$1 != "object" || fmtDef$1 instanceof RegExp || typeof fmtDef$1.compare != "function") throw new Error(`"${keyword$1}": format "${format$2}" does not define "compare" function`);
				const fmt = gen.scopeValue("formats", {
					key: format$2,
					ref: fmtDef$1,
					code: opts.code.formats ? (0, codegen_1$2._)`${opts.code.formats}${(0, codegen_1$2.getProperty)(format$2)}` : void 0
				});
...
var require_dist$1 = __commonJS({ "../node_modules/ajv-formats/dist/index.js"(exports, module) {
	...
	function addFormats(ajv, list, fs, exportName) {
		var _a$2;
		var _b;
		(_a$2 = (_b = ajv.opts.code).formats) !== null && _a$2 !== void 0 || (_b.formats = (0, codegen_1$1._)`require("ajv-formats/dist/formats").${exportName}`);
...
var require_vovk_ajv = __commonJS({ "../packages/vovk-ajv/index.js"(exports) {
	...
	const validate = ({ data, schema, ajv, localize = "en", type, endpoint }) => {
		if (data && schema) {
			...
			if (!isValid) {
				...
				throw new vovk_1.HttpException(vovk_1.HttpStatus.NULL, `Ajv validation failed. Invalid ${type} on client for ${endpoint}. ${ajv.errorsText()}`, {
					data,
					errors: ajv.errors
				});
			}
	...
	const configure = ({ options: givenOptions, localize: givenLocalize }) => (input, validation$2, fullSchema$1) => {
		const { options, localize } = getConfig(fullSchema$1);
		const ajv = createAjv({
			...options,
			...givenOptions
...
const StreamingGeneratorControllerRPC = (0, import_dist$1.createRPC)(fullSchema, "foo/client", "StreamingGeneratorControllerRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
...
const WithZodClientControllerRPC = (0, import_dist$1.createRPC)(fullSchema, "foo/client", "WithZodClientControllerRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
const WithYupClientControllerRPC = (0, import_dist$1.createRPC)(fullSchema, "foo/client", "WithYupClientControllerRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
const WithDtoClientControllerRPC = (0, import_dist$1.createRPC)(fullSchema, "foo/client", "WithDtoClientControllerRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
...
const NoValidationControllerOnlyEntityRPC = (0, import_dist$1.createRPC)(fullSchema, "generated", "NoValidationControllerOnlyEntityRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
const NoValidationControllerAndServiceEntityRPC = (0, import_dist$1.createRPC)(fullSchema, "generated", "NoValidationControllerAndServiceEntityRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
...
const ZodControllerAndServiceEntityRPC = (0, import_dist$1.createRPC)(fullSchema, "generated", "ZodControllerAndServiceEntityRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
...
const YupControllerAndServiceEntityRPC = (0, import_dist$1.createRPC)(fullSchema, "generated", "YupControllerAndServiceEntityRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
...
const DtoControllerAndServiceEntityRPC = (0, import_dist$1.createRPC)(fullSchema, "generated", "DtoControllerAndServiceEntityRPC", {
	fetcher: import_dist.fetcher,
	validateOnClient: import_vovk_ajv.validateOnClient,
	defaultOptions: { apiRoot: "http://localhost:3000/api" }
});
