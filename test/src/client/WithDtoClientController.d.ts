...
export default class WithDtoClientController {
    ...
    static handleNestedQueryClient: (req: VovkRequest<never, HandleNestedQueryDto>) => Promise<HandleNestedQueryDto>;
    ...
    static handleOutputClient: (req: VovkRequest<never, HandleOutputQueryDto>) => Promise<{
        hello: "world";
    }>;
    ...
    static handleQueryClient: (req: VovkRequest<never, HandleQueryQueryDto>) => Promise<HandleQueryQueryDto>;
    static handleBody: ((req: VovkRequest<HandleBodyBodyDto, any, any>) => Promise<HandleBodyBodyDto>) & {
        __output: any;
        __iteration: any;
    };
    static handleBodyClient: (req: VovkRequest<HandleBodyBodyDto>) => Promise<HandleBodyBodyDto>;
    static handleParams: ((req: VovkRequest<any, any, HandleParamsDto>) => Promise<HandleParamsDto>) & {
        __output: any;
        __iteration: any;
    };
    static handleParamsClient: (_req: VovkRequest, params: HandleParamsDto) => Promise<HandleParamsDto>;
}
