...
const defaultController = createRPC<typeof ClientController>(schema, 'foo/client', 'CommonControllerRPC', {
...
describe('Internal client API', () => {
  ...
  it('Should handle custom options', async () => {
    const noOptionsController = createRPC<typeof ClientController>(schema, 'foo/client', 'CommonControllerRPC');
