...
exports.ClientControllerRPC = clientizeController(schema['foo/client'].controllers.ClientControllerRPC, 'foo/client', {
  fetcher,
  validateOnClient,
...
exports.NoValidationControllerServiceAndWorkerEntityWPC = promisifyWorker(
  null,
