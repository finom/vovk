...
export const ClientControllerRPC = clientizeController<Controllers1['ClientControllerRPC'], Options>(
  ...
  'foo/client',
  { fetcher, validateOnClient, defaultOptions: { prefix } }
);
...
export const StreamingGeneratorControllerRPC = clientizeController<
  Controllers1['StreamingGeneratorControllerRPC'],
  Options
>(schema['foo/client'].controllers.StreamingGeneratorControllerRPC, 'foo/client', {
  fetcher,
  validateOnClient,
...
export const NoValidationControllerOnlyEntityRPC = clientizeController<
  Controllers2['NoValidationControllerOnlyEntityRPC'],
  Options
>(schema['generated'].controllers.NoValidationControllerOnlyEntityRPC, 'generated', {
  fetcher,
  validateOnClient,
  defaultOptions: { prefix },
});
export const NoValidationControllerServiceAndWorkerEntityRPC = clientizeController<
  Controllers2['NoValidationControllerServiceAndWorkerEntityRPC'],
  Options
>(schema['generated'].controllers.NoValidationControllerServiceAndWorkerEntityRPC, 'generated', {
  fetcher,
  validateOnClient,
  defaultOptions: { prefix },
});
...
export const ZodControllerAndServiceEntityRPC = clientizeController<
  Controllers2['ZodControllerAndServiceEntityRPC'],
  Options
>(schema['generated'].controllers.ZodControllerAndServiceEntityRPC, 'generated', {
  fetcher,
  validateOnClient,
  defaultOptions: { prefix },
});
...
export const YupControllerAndServiceEntityRPC = clientizeController<
  Controllers2['YupControllerAndServiceEntityRPC'],
  Options
>(schema['generated'].controllers.YupControllerAndServiceEntityRPC, 'generated', {
  fetcher,
  validateOnClient,
  defaultOptions: { prefix },
});
...
export const DtoControllerAndServiceEntityRPC = clientizeController<
  Controllers2['DtoControllerAndServiceEntityRPC'],
  Options
>(schema['generated'].controllers.DtoControllerAndServiceEntityRPC, 'generated', {
  fetcher,
  validateOnClient,
  defaultOptions: { prefix },
});
export const NoValidationControllerServiceAndWorkerEntityWPC = promisifyWorker<
  Workers2['NoValidationControllerServiceAndWorkerEntityWPC']
>(null, schema['generated'].workers.NoValidationControllerServiceAndWorkerEntityWPC);
