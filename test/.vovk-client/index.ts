...
export const StreamingGeneratorController = clientizeController<Controllers1["StreamingGeneratorController"], Options>(metadata['foo/client'].controllers.StreamingGeneratorController, 'foo/client', { fetcher, validateOnClient, defaultOptions: { prefix } });
export const CostomMetadataController = clientizeController<Controllers1["CostomMetadataController"], Options>(metadata['foo/client'].controllers.CostomMetadataController, 'foo/client', { fetcher, validateOnClient, defaultOptions: { prefix } });
export const WithZodClientController = clientizeController<Controllers1["WithZodClientController"], Options>(metadata['foo/client'].controllers.WithZodClientController, 'foo/client', { fetcher, validateOnClient, defaultOptions: { prefix } });
export const WithYupClientController = clientizeController<Controllers1["WithYupClientController"], Options>(metadata['foo/client'].controllers.WithYupClientController, 'foo/client', { fetcher, validateOnClient, defaultOptions: { prefix } });
export const WithDtoClientController = clientizeController<Controllers1["WithDtoClientController"], Options>(metadata['foo/client'].controllers.WithDtoClientController, 'foo/client', { fetcher, validateOnClient, defaultOptions: { prefix } });
