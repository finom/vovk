...
class TestDto(unittest.TestCase):
    ...
    def test_body(self) -> None:
        ...
        self.assertRegex(str(context2.exception), r"DTO validation failed\. Invalid body on server. hello must be shorter than or equal to 5 characters")
    ...
    def test_query(self) -> None:
        ...
        self.assertRegex(str(context2.exception), r"DTO validation failed\. Invalid query on server. search must be shorter than or equal to 5 characters")
    ...
    def test_nested_query(self) -> None:
        ...
        self.assertRegex(str(context1.exception), r"DTO validation failed\. Invalid query on server. x must be shorter.*")
    ...
    def test_params(self) -> None:
        ...
        self.assertRegex(str(context2.exception), r"DTO validation failed\. Invalid params on server. bar must be shorter than or equal to 5 characters")
    ...
    def test_output(self) -> None:
        ...
        self.assertRegex(str(context.exception), r"DTO validation failed\. Invalid output on server. hello must be shorter than or equal to 5 characters")
    ...
    def test_stream(self) -> None: ## TODO: StreamException???
        ...
        with self.assertRaises(Exception) as context:
            for data in iterator:
                print(data)
                pass
        self.assertRegex(str(context.exception), r"DTO validation failed\. Invalid iteration #0 on server. value must be one of the following values: a, b, c, d")
    ...
    def test_constraints(self) -> None:
        ...
        for key in no_constraints.keys():
            ...
            self.assertRegex(
                ...
                rf"DTO validation failed\. Invalid body on server. {key}.*",
            )
