...
program
  ...
  .option('--out, --full-out <path>', 'path to output directory for composed client')
  .option('--from, --full-from <templates...>', 'client template names for composed client')
  .option('--full-only', 'generate only composed client even if segmented client is enabled')
